...
import MySimpleDatePicker from '../components/MySimpleDatePicker';
...
export default function AddingScreen({ navigation }) {
  ...
  return (
    ...
    >
      ...
      <MySimpleDatePicker question='день рождения' setData={setDateOfBirth} />
      <MySimpleDatePicker question='день крещения' setData={setDateOfBapt} />
    </View>
  );
}
